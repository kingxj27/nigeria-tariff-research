    ...
    <section className="px-6 md:px-16 py-16 md:py-20 max-w-6xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <div className="bg-white rounded-xl p-6 shadow-sm">
          <p className="font-semibold text-green mb-2">Clear finding</p>
          <p className="text-sm text-slate-700">
            Rice sits on Nigeria's AfCFTA exclusion or long-timeline "sensitive" list, alongside flour, sugar, and
            cement. That's consistent with decades of food-security-driven protection.
          </p>
        </div>
        <div className="bg-white rounded-xl p-6 shadow-sm">
          <p className="font-semibold text-gray mb-2">Important non-finding</p>
          <p className="text-sm text-slate-700">
            No source, primary or secondary, states where refined petroleum or automobiles sit on Nigeria's
            AfCFTA schedule. A clean 3-sector AfCFTA comparison can't be made with confidence.
          </p>
        </div>
      </div>
