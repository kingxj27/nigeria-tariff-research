export default function Header() {
  return (
    <header className="bg-navy text-white px-6 md:px-16 py-20 md:py-28">
      <div className="max-w-5xl mx-auto">
        <p className="text-orange font-semibold tracking-widest text-sm mb-4">
          NIGERIA TARIFF POLICY, 2023-2025
        </p>
